...
function PlaylistSelector(props) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return response.json().then(function (playlist) {
                addSongs(list, playlist, user_id);
              });
  ...
  function () {
    ...
    /*#__PURE__*/
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(list, playlist, user_id) {
      var apiURL, response;
    ...
    return function addSongs(_x5, _x6, _x7) {
...
//# sourceMappingURL=index.js.f32e7d2c830950a41220.hot-update.js.map